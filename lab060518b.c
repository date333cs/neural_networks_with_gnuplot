...
#define SLEEP 100000   /* s表示スピード */
int n_hidden = 3;   /* number of hidden units */
int n_trials = 200; /* number of trainings */
double eta = 0.1; /* learning coefficient */
double lambda=1.0; /* parameter within sigmoid function */
...
main (int argc, char *argv[])
{
  ...
  for (l=0; l<10; l++) { /* demonstrate 10 times */
    ...
    for (t=0; t<n_trials; t++) { 
		...
		/* draw area */
		if ( t % 10 ==0 ){ /* update screen once in a 10 times */
